<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.master" AutoEventWireup="true" CodeFile="new-reports.aspx.cs" Inherits="Admin_Default" %>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="floatings-labels">
                                                <asp:DropDownList ID="ReportAssetType" CssClass="floating-select" CausesValidation="false" value=" " AutoPostBack="true" runat="server" ToolTip="Select Asset Type" required="required" onclick="this.setAttribute('value', this.value);" OnChange="javascript: " OnSelectedIndexChanged="ReportAssetType_SelectedIndexChanged">
                                        ...
                                        <div class="col-md-3">
                                            <div class="floatings-labels">
                                                <asp:DropDownList ID="ReportBy" CssClass="floating-select" value=" " CausesValidation="false" Visible="true" AutoPostBack="true" runat="server" ToolTip="Select Asset Type" required="required" onclick="this.setAttribute('value', this.value);">
                                                    <asp:ListItem Value=""></asp:ListItem>
                                                    <asp:ListItem>Approved Assets</asp:ListItem>
                                                    <asp:ListItem>Rejected Assets</asp:ListItem>
                                                    <asp:ListItem>Remaining Assets</asp:ListItem>
                                                </asp:DropDownList>
                                                <label class="lbltop" for="txtMotherLang">Report By</label>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="floatings-labels">
                                                <asp:DropDownList ID="ReportContent" CssClass="floating-select" value=" " CausesValidation="false" Visible="true" AutoPostBack="true" runat="server" ToolTip="Select Asset Type" required="required" onclick="this.setAttribute('value', this.value);">
                                                    <asp:ListItem Value=""></asp:ListItem>
                                                    <asp:ListItem>Asset ID</asp:ListItem>
                                                    <asp:ListItem>Asset Name</asp:ListItem>
                                                    <asp:ListItem>Purchased Date</asp:ListItem>
                                                    <asp:ListItem>Company Location</asp:ListItem>
                                                </asp:DropDownList>
                                                <label class="lbltop" for="txtMotherLang">Report Content</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6" id="searchdiv" runat="server" visible="false">
                                            <div class="floatings-labels">
                                                <asp:TextBox ID="txtFindVendor" runat="server" Visible="true" CssClass="floating-input" PlaceHolder=" " ToolTip="Please enter some keywords and Search.." AutoPostBack="true"></asp:TextBox>
