<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.master" AutoEventWireup="true" CodeFile="ersEmployee.aspx.cs" Inherits="Admin_Default" EnableEventValidation="false" %>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            ...
                            <button class="btn btn-primary btn-sm tooltips pull-right" onclick="location.href='NewAddEmployee.aspx'" type="button" title="" data-placement="top" data-toggle="tooltip" data-original-title="Create Member"><i class="fa fa-pencil"></i>Add Employee </button>
...
<asp:Button ID="Cancelsearch"  UseSubmitBehavior="false" CausesValidation="false" OnClick="Cancelsearch_Click"  runat="server" Text="Clear" CssClass="btn btn-success btn-block"  style="margin-top: 15px;"   />
                                ...
                                <div class="table-responsive">
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand" EmptyDataText="No records found" OnRowDataBound="GridView1_RowDataBound"
                                        CssClass="table table-bordered table-striped    table-inverse nomargin" PopupControlID="divViewEmp" DataKeyNames="EmployeeID">
                                        <Columns>
                                            <asp:BoundField DataField="EmployeeID" HeaderText="EmployeeID" ReadOnly="True" SortExpression="EmployeeID" />
                                            <asp:BoundField DataField="EmployeeName" HeaderText="Name" SortExpression="EmployeeName" />
                                            <asp:BoundField DataField="EmployeeMailID" HeaderText="MailID" SortExpression="EmployeeMailID" />
                            ...
                            <div class="row mb20">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <asp:Label ID="edesignation" runat="server" Font-Bold="true"> Designation</asp:Label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <asp:Label ID="edepartment" for="nMobileNumber1" runat="server" Font-Bold="true">Department</asp:Label>
