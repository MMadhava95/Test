<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.master" AutoEventWireup="true" CodeFile="AdminAllTickets.aspx.cs" Inherits="Admin_Default" %>
                        ...
                        <div class="panel-heading">
                            ...
                            <div class="panel-body">
                                                ...
                                                <div class="panel-body">
                                                    <div class="row">
                                                        <div class="col-xs-7 col-lg-8">
                                                            ...
                                                            <p class="colorwhite">No.of High tickets</p>
                                                        </div>
                                                        <div class="col-xs-5 col-lg-4 text-right">
                                                            <h1 class="fsize70"><i class="fa fa-ticket"></i></h1>
                                                        </div>
                                                ...
                                                <div class="panel-body">
                                                    <div class="row">
                                                        <div class="col-xs-7 col-lg-8">
                                                            ...
                                                            <p class="colorwhite">No.of Moderate Tickets</p>
                                                        </div>
                                                        <div class="col-xs-5 col-lg-4 text-right">
                                                            <h1 class="fsize70"><i class="fa fa-ticket"></i></h1>
                                                        </div>
                                                ...
                                                <div class="panel-body">
                                                    <div class="row">
                                                        <div class="col-xs-7 col-lg-8">
                                                            ...
                                                            <p class="colorwhite">No.of Low Tickets</p>
                                                        </div>
                                                        <div class="col-xs-5 col-lg-4 text-right">
                                                            <h1 class="fsize70"><i class="fa fa-ticket"></i></h1>
                                                        </div>
                              ...
                              <div class="table-responsive">
                                  ...
                                  <asp:GridView ID="GridView1" emptydatatext="No Records Found" runat="server" AutoGenerateColumns="true"
                                ...
                                <div class="form mb20">
                                    <div class="col-md-3">
                                        <div class="floatings-labels">
                                            ...
                                            <asp:DropDownList runat="server" ID="DropDownList1" AutoPostBack="true"   CssClass="floating-select" value="" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" onclick="this.setAttribute('value', this.value);" >
                                    ...
                                    <div class="col-md-3">
                                           ...
                                           <asp:DropDownList ID="DropDownList2" runat="server"  CssClass="floating-select" Style="margin-top: 15px;"> 
                                               <asp:ListItem></asp:ListItem>
                                           </asp:DropDownList>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphFooter" runat="Server">
    ...
    <script type="text/javascript">
        ...
        //    $("#liadmintickets").addClass("active");
