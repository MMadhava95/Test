<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.master" AutoEventWireup="true" CodeFile="Addemployee.aspx.cs" Inherits="Admin_Default" %>
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form mb20">
                                ...
                                <div class="col-md-3">
                                    <div class="floatings-labels">
                                        <asp:TextBox ID="empname" runat="server" CssClass="floating-input" placeholder=" "></asp:TextBox>
                                ...
                                <div class="col-md-3">
                                    <div class="floatings-labels">
                                        <asp:TextBox ID="empmailid" runat="server" CssClass="floating-input" placeholder=" "></asp:TextBox>
                                ...
                                <div class="col-md-3">
                                    <div class="floatings-labels">
                                        <asp:TextBox ID="empdesignation" runat="server" CssClass="floating-input" placeholder=" "></asp:TextBox>
                                ...
                                <div class="col-md-3">
                                    <div class="floatings-labels">
                                        <asp:TextBox ID="empdepartment" runat="server" CssClass="floating-input" placeholder=" "></asp:TextBox>
                                ...
                                <div class="col-md-3">
                                    <div class="floatings-labels">
                                        <asp:TextBox ID="emplocation" runat="server" CssClass="floating-input" placeholder=" "></asp:TextBox>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <asp:Button ID="submit" runat="server" Text="Submit" ValidationGroup="one" class="btn btn-success   btn-block" Style="margin-top: 10px;" />
                                </div>
