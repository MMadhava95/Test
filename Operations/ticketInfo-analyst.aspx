<%@ Page Title="" Language="C#" MasterPageFile="~/Operations/emp.master" AutoEventWireup="true" CodeFile="ticketInfo-analyst.aspx.cs" Inherits="Operations_Default" %>
            ...
            <div class="row profile-wrapper">
                <div class="col-xs-12 col-md-3 col-lg-3 profile-left">
                    <div class="profile-left-heading">
                        ...
                        <%--<asp:Button runat="server" class="btn btn-danger btn-quirk btn-block profile-btn-follow" Text="ReAssign Ticket"></asp:Button>--%>
                    </div>
                   ...
                   <p>
                                ...
                                <div class="col-md-3">
                                    <div class="floatings-labels">
						                ...
						                <asp:ListItem>Waiting for Customer Reply</asp:ListItem>
                                 ...
                                 <div class="col-md-3">
                                    ...
                                    <asp:Button ID="Update_Ticket_Status" runat="server" Text="Update Ticket" class="btn btn-success   btn-block" Style="margin-top: 10px;" OnClick="Update_Ticket_Status_Click" />
                                </div>
                                  ...
                                  <div class="col-md-3">
                                    <div class="floatings-labels">
                                        <asp:DropDownList ID="DropDownList2" CssClass="floating-select" runat="server" value="" onclick="this.setAttribute('value', this.value);">
                                            ...
                                            <asp:ListItem>Software Developer Trainer</asp:ListItem>
                                        </asp:DropDownList>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <asp:Button ID="ChangeDepartment" runat="server" Text="Reassign" class="btn btn-success   btn-block" Style="margin-top: 10px;"  OnClick="ChangeDepartment_Click"/>
                                </div>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="photos">
                                <div class="form mb20">
                                    ...
                                    <div class="col-md-3">
                                        <asp:Button ID="MailToUser" runat="server" Text="Mail to User" class="btn btn-success   btn-block" Style="margin-top: 10px;" OnClick="MailToUser_Click1" />
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            <div class="tab-pane" id="music">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-12 text-center mb20">
                                        ...
                                        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" Height="75px" Width="321px" RowStyle-HorizontalAlign="Center" CellPadding="4" ForeColor="#333333" GridLines="None">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Download">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkDownload" runat="server" Text="" OnClick="lnkDownload_Click" CommandArgument='<%# Eval("TMSAttachment") %>'><i class="fa fa-download" aria-hidden="true" style="font-size:large;color:#2bbbad"></i></asp:LinkButton>
