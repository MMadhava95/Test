<%@ Page Title="" Language="C#" MasterPageFile="emp.master" AutoEventWireup="true" CodeFile="mycourses.aspx.cs" Inherits="mycourses" %>
        ...
        <div class="contentpanel">
            ...
            <div class="row">
                <div class="col-md-12 padding10 paddingtop10">
                    ...
                    <button class="btn btn-success btn-sm tooltips pull-right" type="button" title="" onclick="location.href='mycourse.aspx'" data-placement="top" data-toggle="tooltip" data-original-title="Go to Your Registered Courses"><i class="fa fa-pencil"></i>Go to my courses </button>
                    ...
                    <div>
                       <%-- <!--preloader---->
                        ...
                        <asp:DataList ID="dlCourseList1" Width="100%" runat="server" RepeatColumns="3" CellSpacing="3" RepeatLayout="Table">
                            <ItemTemplate>
                        ...
                        <asp:DataList ID="dlCourseList2" Width="100%" runat="server" RepeatColumns="3" CellSpacing="3" RepeatLayout="Table">
                            <ItemTemplate> 
                        ...
                        <asp:DataList ID="dlCourseList3" Width="100%" runat="server" RepeatColumns="3" CellSpacing="3" RepeatLayout="Table">
                            <ItemTemplate> 
                                <div class="col-md-12 mb20">
