...
public partial class EmployeeSoftwareAssets : System.Web.UI.Page
{
    ...
    void SwAssets()
    {
        ...
        SqlCommand swcmd = new SqlCommand("SELECT * FROM EmployeeAssetRequestTable as emp " +
            ...
            "join Software_Assets as SA on SA.AMSSW_AssetID = emp.AssetID " +
            "where RequestStatus = 'Approved' AND AssetType = 'Software Assets' AND RequestedEmployeeMailId = '" + Session["SessionUserMailID"].ToString() + "'", con);
